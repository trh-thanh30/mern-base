...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      const res = await fetch(`http://localhost:3001/user/api/register`, {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      <h1 className="text-center font-bold text-3xl mt-28">Register</h1>
      {error && (
        <div
          id="toast-danger"
      ...
      <div className="flex items-center justify-center gap-1 mt-2">
        ...
        <Link to="/signin" className="text-blue-500 text-base">
          login
        </Link>
      </div>
    </div>
